...
using Orochi.Protections.Mutations.Arithmetic.Function.Maths;
using Orochi.Protections.Mutations.Arithmetic.Function;
using Orochi.Core.Interfaces;
using Orochi.Core;

namespace Orochi.Protections.Mutations
{
    public class MutationProtection : IProtection
    {
        ...
        List<iFunction> Tasks = new List<iFunction>()
            {
                ...
                new Arithmetic.Function.Sub(),
                new Arithmetic.Function.Div(),
                new Arithmetic.Function.Mul(),
                new Arithmetic.Function.Xor(),
                new Arithmetic.Function.Maths.Abs(),
                new Arithmetic.Function.Maths.Log(),
                new Arithmetic.Function.Maths.Log10(),
                new Arithmetic.Function.Maths.Sin(),
                new Arithmetic.Function.Maths.Cos(),
                new Arithmetic.Function.Maths.Floor(),
                new Arithmetic.Function.Maths.Round(),
                new Arithmetic.Function.Maths.Tan(),
                new Arithmetic.Function.Maths.Tanh(),
                new Arithmetic.Function.Maths.Sqrt(),
                new Arithmetic.Function.Maths.Ceiling(),
                new Arithmetic.Function.Maths.Truncate()
            };
