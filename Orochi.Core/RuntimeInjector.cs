...
namespace Orochi.Core
{
    public static class RuntimeInjector
    {
        ...
        //https://forum.tuts4you.com/topic/37273-dnlib-injecting-class-with-method/
        //Not working
        public static void Inject(ModuleDef thismodule, OrochiContext context, IMethod meth, TypeDef type)
        {
            thismodule.Types.Remove(type);
            System.Threading.Thread.Sleep(3000);
            type.Methods.Add(meth.ResolveMethodDef()); // Catching Null exception here.

            context.Module.Types.Add(type); // Adding new type into our module.
        }
        ...
        class InjectContext
        {
            ...
            {
                OriginModule = target; //Tried to fix reference adding thing
                TargetModule = target;
