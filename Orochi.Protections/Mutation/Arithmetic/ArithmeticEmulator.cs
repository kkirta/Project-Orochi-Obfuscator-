...
namespace Orochi.Protections.Mutations.Arithmetic
{
    public class ArithmeticEmulator
    {
        ...
        {
            Orochi.Protections.Mutations.Arithmetic.Utils.Generator gen = new Orochi.Protections.Mutations.Arithmetic.Utils.Generator();
            ArithmeticTypes arithmetic = arithmetics[gen.Next(arithmetics.Count)];
            GetType = arithmetic;
            switch (ArithmeticTypes)
            {
